...
exports.makeRPCall = undefined;

let makeRPCall = exports.makeRPCall = (() => {
    var _ref = _asyncToGenerator(function* (parameters) {
        var options = {
            ...
            'data': _qs2.default.stringify(parameters)
        };
        var result = null;
...
var utilities = __webpack_require__(40);
